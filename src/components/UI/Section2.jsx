        ...
        <div>
            <div className='flex bg-white max-w-260 mx-auto pt-60 pb-20 items-start'>
                <div className='w-full flex flex-col items-center justify-center py-6'>
                    <img className='w-6/7 rounded-full relative' src="/src/assets/sec2Images/sec2Img1.png" alt="Agriculture" />
                    <img className='w-1/6 absolute top-355 left-50 border-8 border-white rounded-full' src="/src/assets/sec2Images/sec2Img2.png" alt="Sustainability" />
                </div>
                <div className='w-full flex flex-col items-start gap-3 p-6'>
                    ...
                    <div className='flex gap-10 mt-6'>
                        <div className='flex gap-4 items-center'>
                            <img className='w-12' src="/src/assets/sec2Images/svg1.png" alt="Icon 1" />
                            <h4 className='text-start text-md font-extrabold'>Growing fruits<br /> vegetables</h4>
                        </div>
                        <div className='flex gap-4 items-center'>
                            <img className='w-12' src="/src/assets/sec2Images/svg2.png" alt="Icon 1" />
